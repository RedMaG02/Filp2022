...
let button1 = new Button(Text="Ввести массив 1", Left=250, Top=100, Width=200,Height=50)
let button2 = new Button(Text="Фильтр массива", Left=250, Top=200, Width=200,Height=50)
