...
[<EntryPoint>]
let main argv =
    Console.WriteLine(NumberOfChetnNotVzaimProstWithX 15) // 12 10 6  = 3
    Console.WriteLine(MaksCifrChislaNotDividedBy3 76359 ) //7 
    Console.WriteLine(MaksWhichNodWithXNot1AndNotDividedByMinimalDiviDerOfXX 15 ) // 12 10 9 6 5 3 -> mindel(15) = 3 -> 10%3 != 0 ->-> 10 * 1 = 10
